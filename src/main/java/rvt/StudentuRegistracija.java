...
public class StudentuRegistracija {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            // Используем CYAN для заголовка меню
            System.out.println("\n" + ConsoleColors.CYAN.getCode() + "Choose action:" + ConsoleColors.RESET.getCode());
            ...
            try {
                switch (choice) {
                    ...
                    default:
                        ...
                        System.out.println(ConsoleColors.RED.getCode() + "Invalid choice." + ConsoleColors.RESET.getCode());
                }
            } catch (Exception e) {
                
                System.out.println(ConsoleColors.RED.getCode() + "Error: " + e.getMessage() + ConsoleColors.RESET.getCode());
            }
        }
    }
    ...
    private static void register() throws Exception {
        ...
        System.out.println(ConsoleColors.GREEN.getCode() + "Student registered successfully." + ConsoleColors.RESET.getCode());
    }

    // SHOW
    private static void showAll() {
        
        System.out.println(ConsoleColors.YELLOW.getCode() + "------------------------------------------------------------------------------------------------");
        System.out.printf("| %-10s | %-10s | %-20s | %-15s | %-20s |\n",
                "FirstName", "LastName", "Email", "PersonalCode", "RegistrationDate");
        System.out.println("------------------------------------------------------------------------------------------------" + ConsoleColors.RESET.getCode());
        ...
        System.out.println(ConsoleColors.YELLOW.getCode() + "------------------------------------------------------------------------------------------------" + ConsoleColors.RESET.getCode());
    }
    ...
    private static void remove() {
        ...
        System.out.println(ConsoleColors.GREEN.getCode() + "Student removed." + ConsoleColors.RESET.getCode());
    }
    ...
    private static void edit() throws Exception {
        ...
        for (Student s : students) {
            if (s.personalCode.equals(code)) {
                ...
                saveStudents();
                System.out.println(ConsoleColors.GREEN.getCode() + "Student updated." + ConsoleColors.RESET.getCode());
                return;
            }
        }
        System.out.println(ConsoleColors.RED.getCode() + "Student not found." + ConsoleColors.RESET.getCode());
    }
    ...
    private static void saveStudents() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(FILE_NAME))) {
            ...
            System.out.println(ConsoleColors.RED.getCode() + "File error." + ConsoleColors.RESET.getCode());
        }
    }
